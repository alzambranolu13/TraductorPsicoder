...
def main(argv):
    ...
    marco = ttk.Frame(window,borderwidth=3,relief="ridge",padding=(10,10))
    marcoCode = ttk.Frame(marco,borderwidth=2,relief="ridge",padding=(10,10))
    marcoCodetrad = ttk.Frame(marco,borderwidth=2,relief="ridge",padding=(10,10))
    marcoButtons = ttk.Frame(marco,borderwidth=2,relief="ridge",padding=(10,10))
    #Psicoder text
    fuentecode = ("Consolas","15")
    tPsicoder = tk.Text(marcoCode,width=50,height=20,bg="#16172B",fg="#8A8AA7",tabs=("1c"),yscrollcommand=True)
    ...
    tPython = tk.Text(marcoCodetrad,width=50,height=20,bg="#16172B",fg="#8A8AA7",tabs=("1c"),yscrollcommand=True)
